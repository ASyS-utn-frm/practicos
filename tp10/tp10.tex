...
regiones de convergencia con forma circular o de disco. Al igual que con la TL, en general los lí­mites de la región de 
convergencia de la TZ, estarán determinados por los polos de $X(z)$.

La transformada $z$ inversa se define mediante la integral de lí­nea:
\begin{equation}
...
incluir la circunferencia límite). Vemos también que la región está delimitada por la posición del polo de $X(z)$.
\end{enumerate}
...
\begin{enumerate}
	...
	pocas 	muestras, podemos hallar su TZ explí­citamente:
	\begin{align}
