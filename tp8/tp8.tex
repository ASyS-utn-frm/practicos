...
\lhead{\footnotesize  A\~no \the\year{} Ver. 2021.11.19}
\chead{}
...
\subsection*{Frecuencia de alias}

La frecuencia de alias se define como: $\omega_{alias}=\omega_s - \omega_{max}$. Para una señal submuestreada, es decir que sufre de aliasing en la frecuencia, se tiene que $\omega_{alias}<\omega_{max}$. 
