...
Siguiendo con la analogí­a vectorial, se define el cuadrado de la \textbf{norma} de una función $x_n(t)$, mediante el 
producto:
\begin{equation}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
	...
	La serie trigonométrica de Fourier de una señal periódica $ x(t) $ con perí­odo $ T $ es:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	De lo anterior se desprende que la serie de Fourier de una señal par de perí­odo T es una \textbf{``Serie de 
	Fourier de cosenos"}
	\begin{equation}
	...
	La serie de Fourier de una función impar de perí­odo T es una \textbf{``Serie de Fourier de senos"}
	\begin{equation}
...
Previo al c\'alculo de los coeficientes, podemos observar las caracterí­sticas de simetr\'ia de la funci\'on, para que en caso de presentar alguna simetr\'ia, evitemos realizar el c\'alculo de los coeficientes que se anulan. Se puede observar que estamos ante el caso de una funci\'on con simetr\'ia impar. Para las funciones impares solo subsiste el coeficiente $b_n$, siendo $a_0=0$ y $a_n=0$. Por lo tanto, para este caso solo calculamos $b_n$.
...
\begin{figure}[h]
	...
	calculado por el programa no es impar como deberí­a ser, pues $x(t)$ es una señal real. Esto se debe a que el 
...
un sistema LTI, el mismo actuarí­a como un filtro pasa bajos, a saber, un sistema que atenúa las frecuencias altas 
